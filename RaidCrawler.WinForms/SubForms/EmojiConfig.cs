...
public partial class EmojiConfig : Form
{
    ...
    private static readonly Dictionary<string, string> _vioPresets = new()
    {
        ...
        { "Male", "<:male:1398752153580998778>"},
        { "Female", "<:female:1398752952013029520>"},
        { "Shiny", "<:shiny:1398753052760215572>"},
        { "Square Shiny", "<:square:1398753103091732500>"},
        { "Event Star", "<:raidStarB:1398753233005969419>"},
        { "7 Star", "<:raidStarM:1398753300014301305>"},
        { "Star", "<:raidStarY:1398753351717621861>"},
